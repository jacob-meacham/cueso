...
TOOL_DEFINITIONS: list[Tool] = [
    ...
    Tool(
        ...
        description=(
            ...
            "content to find. Pass season and episode ONLY when the user asked for a "
            "specific episode — the match will target exactly that episode. For "
            "'watch/resume/continue' a show, pass just the title: services with resume "
            "support continue where the user left off. After calling this, use "
            "launch_on_roku with the returned values to play content. Matches with "
            "deep_link=false (Apple TV+) can only "
